      ...
      <Screen>
        <Slide>
          ...
          <p class="outcomeBalls">
            <Ball class="col" :color="getColorLeftUrn(trial.earlyBall)" :type="trial.earlyBall"/>
            <Ball clas="col" :color="getColorRightUrn(trial.lateBall)" :type="trial.lateBall"/>
          </p>
...
main_trials[11]['attentionCheck'] = true
