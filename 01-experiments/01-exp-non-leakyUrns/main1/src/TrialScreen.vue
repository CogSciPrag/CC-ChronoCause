...
<template>
  <Screen :progress="props.index/props.length">
    <Slide>
    ...
    <Slide>
      ...
      <p>
        <b>Getting a {{ props.which_urn_prompted_first === "left" ? getLeftColor() : getRightColor() }}
      ...
      <p>
        <b>Getting a {{ props.which_urn_prompted_first === "left" ? getRightColor() : getLeftColor() }}
          ball caused Alice to
